...
urlpatterns = [
    ...
    path('mechanical-engineering/', views.mechanical_engineering, name='mechanical-engineering'),
    path('agricultural-processing/', views.agricultural_processing, name='agricultural-processing'),
    path('petrolium/', views.petrolium, name='petrolium'),
    path('material-engineering', views.material_engineering, name = 'material-engineering'),
    path('coachingforemployment/', views.coachingforemployment, name='coachingforemployment'),
    path('cybersecurity/', views.cybersecurity, name='cybersecurity')
